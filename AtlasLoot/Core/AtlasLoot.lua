...
AtlasLoot_DewDropDown = {
	[1] = {
		[AL["Dungeons & Raids"]] = {
			...
			[28] = { 
				{ AL["Black Morass"], "BlackMorass", "Submenu" },
			},
		},
	},
	[2] = {
	...
	[4] = {
		[AL["Sets/Collections"]] = {
			...
			[17] = { 
				{ AL["Hateforge 1 Sets"], "HF1Sets", "Submenu" },
			},
			[18] = { 
				{ AL["Hateforge i58 Sets"], "i58Sets", "Submenu" },
			},
		},
	},
	[5] = {
...
AtlasLoot_DewDropDown_SubTables = {
	...
	["BlackMorass"] = {
		{ AL["Chrono-Lord Temporia"], "BlMoTemporia" },
		{ AL["Echo of E'khem"], "BlMoEkhem" },
		{ AL["Echo of Malchezzar"], "BlMoMalchezzar"},
		{ AL["Trash Mobs"], "BlMoTrash" },
	},
	["WorldBosses"] = {
	...
	["HF1Sets"] = {
		{ "|cffffffff"..AL["Priest"], "HF1Priest1" },
		{ "|cff68ccef"..AL["Mage"], "HF1Mage1" },
		{ "|cff9382c9"..AL["Warlock"], "HF1Warlock1" },
		{ "|cfffff468"..AL["Rogue"], "HF1Rogue1" },
		{ "|cffff7c0a"..AL["Druid"], "HF1Druid1" },
		{ "|cffaad372"..AL["Hunter"], "HF1Hunter1" },
		{ "|cff2773ff"..AL["Shaman"], "HF1Shaman1" },
		{ "|cfff48cba"..AL["Paladin"], "HF1Paladin1" },
		{ "|cffc69b6d"..AL["Warrior"], "HF1Warrior1" },
	},
	["i58Sets"] = {
		{ "|cffffffff"..AL["Priest"], "i58Priest" },
		{ "|cff68ccef"..AL["Mage"], "i58Mage" },
		{ "|cff9382c9"..AL["Warlock"], "i58Warlock" },
		{ "|cfffff468"..AL["Rogue"], "i58Rogue" },
		{ "|cffff7c0a"..AL["Druid"], "i58Druid" },
		{ "|cffaad372"..AL["Hunter"], "i58Hunter" },
		{ "|cff2773ff"..AL["Shaman"], "i58Shaman" },
		{ "|cfff48cba"..AL["Paladin"], "i58Paladin" },
		{ "|cffc69b6d"..AL["Warrior"], "i58Warrior" },
	},
	["ZGSets"] = {
