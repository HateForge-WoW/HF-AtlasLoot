...
AtlasLoot_ButtonRegistry = {
	...
	["HF1Druid1"] = {
		Title = AL["Druid"];
		Next_Page = "HF1Druid2";
		Next_Title = AL["Hateforge 1 Sets"];
	...
	["HF1Paladin1"] = {
		Title = AL["Paladin"];
		Next_Page = "HF1Paladin2";
		Next_Title = AL["Hateforge 1 Sets"];
		
	};
	["HF1Paladin2"] = {
		Title = AL["Paladin"];
		Prev_Page = "HF1Paladin1";
		Prev_Title = AL["Paladin"];
		
	};
	["HF1Priest1"] = {
		Title = AL["Priest"];
		Next_Page = "HF1Priest2";
		Next_Title = AL["Priest"];
		
	};
	["HF1Priest2"] = {
		Title = AL["Priest"];
		Prev_Page = "HF1Priest1";
	...
	["HF1Shaman1"] = {
		Title = AL["Shaman"];
		Next_Page = "HF1Shaman2";
		Next_Title = AL["Shaman"];
		
	};
	["HF1Shaman2"] = {
		Title = AL["Shaman"];
		Prev_Page = "HF1Shaman1";
