...
AtlasLoot_Data["AtlasLootItems"] = {
 ...
 WCDeviateFaerieDragon = {
	...
	BlMoTrash = {
{ 85100,"INV_Helmet_49" , "=q3=Shisui’s Fishing Hat",""},
{ 85101,"INV_Belt_21" , "=q3=Shisui’s Bait Belt",""},
{ 85102,"INV_Boots_09" , "=q3=Shisui’s Fishing Boots",""},
{ 85103,"INV_Chest_Cloth_22" , "=q3=Shisui’s Fishing Robe of Tranquility",""},
{ 85104,"INV_Jewelry_Ring_21" , "=q4=Flame-Strengthened Ribbon",""},
{ 85105,"INV_Misc_Head_Dragon_01" , "=q4=Flame-Strengthened Brooch",""},
{ 85106,"INV_Boots_07" , "=q3=Fireproof Sandals",""},
{ 85107,"INV_Boots_01" , "=q3=Fireproof Boots",""},
{ 85108,"INV_Boots_Chain_10" , "=q3=Fireproof Chainmail Boots",""},
{ 85109,"INV_Boots_Plate_06" , "=q3=Fireproof Plate Boots",""},
{ 85110,"INV_Shoulder_02" , "=q3=Fireproof Shoulder Pads",""},
{ 85111,"INV_Shoulder_01" , "=q3=Fireproof Shoulder Guard",""},
{ 85112,"INV_Shoulder_11" , "=q3=Fireproof Shoulder Flaps",""},
{ 85113,"INV_Shoulder_01" , "=q3=Fireproof Pauldrons",""},
{ 85114,"INV_Jewelry_Ring_15" , "=q3=Band of Arcane Resistance",""},
{ 85115,"INV_Misc_Rune_05" , "=q3=Brooch of Arcane Resistance",""},
{ 85116,"INV_Helmet_29" , "=q3=Arcane Veil",""},
};
	BlMoTemporia = {
{ 85117,"INV_Shoulder_30" , "=q3=Stormblade Spaulders","","20%"},
{ 85118,"INV_Bracer_07" , "=q3=Shimmering Arcane Shackles","","20%"},
{ 85119,"INV_Boots_07" , "=q3=Lightwoven Sandals","","20%"},
{ 85120,"INV_Boots_Plate_09" , "=q3=Blessstride Boots","","20%"},
{ 85121,"INV_Boots_08" , "=q3=Naturewoven Leather Slippers","","20%"},
{ 85122,"INV_Bracer_18" , "=q3=Steel-Forged Bracers","","20%"},
{ 85123,"INV_Chest_Cloth_25" , "=q3=Robes of the Flameheart","","20%"},
{ 85124,"INV_Chest_Chain_13" , "=q3=Breastplate of the Flameheart","","20%"},
{ 85125,"INV_Misc_Cape_05" , "=q3=Magic Cloak of Promise","","20%"},
{ 85126,"INV_Misc_Cape_18" , "=q3=Emberblade Cape","","20%"},
};
	BlMoEkhem = {
{ 85127,"INV_Misc_Cape_05" , "=q3=Fireproof Cloak","","20%"},
{ 85128,"INV_Misc_Cape_04" , "=q3=Forest Stalker Cape","","20%"},
{ 85129,"INV_Staff_07" , "=q3=Dragon's Breath Staff","","20%"},
{ 85130,"INV_Pants_14" , "=q3=Starborn Aether Trousers","","20%"},
{ 85131,"INV_Belt_03" , "=q3=Hero's Blade Pact","","20%"},
{ 85132,"INV_Gauntlets_06" , "=q3=Ringo's Blizzard Hands","","20%"},
{ 85133,"INV_Staff_02" , "=q3=Ringo's Blizzard Finger","","20%"},
{ 85134,"INV_Jewelry_Necklace_14" , "=q3=Glyph-Adorned Necklace","","20%"},
{ 85135,"INV_Chest_Chain_17" , "=q3=Bandit's Vest","","20%"},
};
	BlMoMalchezzar = {
{ 85136,"INV_Helmet_46" , "=q3=Falcon Eye Patch","","20%"},
{ 85137,"INV_Weapon_Rifle_05" , "=q3=Pebblehammer's Sniper Rifle","","20%"},
{ 85138,"INV_Axe_04" , "=q3=Pebblehammer's Stonecrusher","","20%"},
{ 85139,"INV_Shield_16" , "=q3=Aegis of Gentleness","","20%"},
{ 85140,"INV_Hammer_02" , "=q3=Mallet of Gentleness","","20%"},
{ 85141,"INV_Jewelry_Talisman_08" , "=q3=Star Pendant","","20%"},
{ 85142,"INV_Jewelry_TrinketPVP_02" , "=q3=Blood Ruby of the Warrior","","20%"},
{ 85143,"INV_Misc_Eye_01" , "=q3=Falcon Eyes Pendants","","20%"},
{ 85144,"INV_Chest_Leather_08" , "=q3=Ranger Armor","","20%"},
{ 85145,"INV_Shoulder_05" , "=q3=Assassin's Shoulder Pieces","","20%"},
};
};
