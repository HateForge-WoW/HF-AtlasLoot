...
AtlasLoot_TableNames = {
	...
	--Black Morass
	["BlMoTemporia"] = { AL["Chrono-Lord Temporia"], "AtlasLootItems" },
	["BlMoEkhem"] = { AL["Echo of E'khem"], "AtlasLootItems" },
	["BlMoMalchezzar"] = { AL["Echo of Malchezzar"], "AtlasLootItems" },
	["BlMoTrash"] = { AL["Trash Mobs"].." ("..AL["Black Morass"]..")", "AtlasLootItems" },
------------
--- Sets ---
------------
	...
	--HF 1 Sets
	["HF1Druid1"] = { AL["Druid"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Druid2"] = { AL["Druid"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Hunter1"] = { AL["Hunter"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Mage1"] = { AL["Mage"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Paladin1"] = { AL["Paladin"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Paladin2"] = { AL["Paladin"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Priest1"] = { AL["Priest"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Priest2"] = { AL["Priest"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Rogue1"] = { AL["Rogue"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Shaman1"] = { AL["Shaman"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Shaman2"] = { AL["Shaman"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Warlock1"] = { AL["Warlock"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	["HF1Warrior1"] = { AL["Warrior"].." - "..AL["Hateforge 1 Sets"], "AtlasLootSetItems" },
	--i58 Sets
	["i58Druid"] = { AL["Druid"].." - "..AL["Hateforge i58 Sets"], "AtlasLootSetItems" },
	["i58Hunter"] = { AL["Hunter"].." - "..AL["Hateforge i58 Sets"], "AtlasLootSetItems" },
	["i58Mage"] = { AL["Mage"].." - "..AL["Hateforge i58 Sets"], "AtlasLootSetItems" },
	["i58Paladin"] = { AL["Paladin"].." - "..AL["Hateforge i58 Sets"], "AtlasLootSetItems" },
	["i58Priest"] = { AL["Priest"].." - "..AL["Hateforge i58 Sets"], "AtlasLootSetItems" },
	["i58Rogue"] = { AL["Rogue"].." - "..AL["Hateforge i58 Sets"], "AtlasLootSetItems" },
	["i58Shaman"] = { AL["Shaman"].." - "..AL["Hateforge i58 Sets"], "AtlasLootSetItems" },
	["i58Warlock"] = { AL["Warlock"].." - "..AL["Hateforge i58 Sets"], "AtlasLootSetItems" },
	["i58Warrior"] = { AL["Warrior"].." - "..AL["Hateforge i58 Sets"], "AtlasLootSetItems" },
------------------------
--- Misc Collections ---
------------------------
...
------------------------
	...
	--CustomLoot
	["CustomLoot1"] = { AL["CustomLoot"], "AtlasLootRepItems" },
	--The Darkmoon Faire
